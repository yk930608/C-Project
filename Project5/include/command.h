...
#define MSG_WITHDRAW(cmd, id, f, a) \
  cmd_pack((cmd), WITHDRAW, (id), (f), -1, (a))
#define MSG_TRANSFER(cmd, id, f, t, a) \
  cmd_pack((cmd), TRANSFER, (id), (f), (t), (a))
...
void cmd_dump(const char *msg, int id, Command *cmd);
