...
int trace_atm_count() { return atm_cnt; }

int trace_account_count() { return account_cnt; }

int trace_read_cmd(Command *cmd) { return read(tracefd, cmd, MESSAGE_SIZE); }
